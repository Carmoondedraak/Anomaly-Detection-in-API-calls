...
class Feature_Selection():
    ...
    def pipes_model(self, X, y,X_test,y_test, model, classifier, k, direction):
        ...
        self.visualise(clf,X,y,model[0],classifier[0])
    ...
    def pipes_filt(self, X, y,X_test,y_test, filt, classifier, k):
        ...
        self.visualise(clf,X,y,filt[0],classifier[0])
    ...
    def visualise(self,clf,X,y, filt,classifier):
        ...
        plt.savefig(filt+'_'+classifier+"extended.png")
        plt.clf()

        fig, ax = plt.subplots(nrows=2, figsize=(16, 12), sharex=True)

        # for i,  in zip(fit_times,score_times):
