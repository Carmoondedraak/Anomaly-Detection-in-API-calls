...
public class OrdersController {
    ...
    CustomerOrder newOrder(@RequestBody NewOrderResource item) {
        try {
            ...
            LOG.info("£££££££££££ ===> REQUEST FROM User Service: " + item);
            ...
            LOG.info("£££££££££££ ===> AddressFuture: " + addressFuture.get());
            LOG.info("£££££££££££ ===> CustomerFuture: " + customerFuture.get());
            LOG.info("£££££££££££ ===> CardFuture: " + cardFuture.get());
            LOG.info("£££££££££££ ===> ItemsFuture: " + itemsFuture.get());
            ...
            String[] elements = item.customer.toString().split("/");
            String customerId = elements[elements.length - 1];
            LOG.info("£££££££££££ ===> Shipment (customerId): " + customerId);
            ...
            LOG.info("£££££££££££ ===> Shipment (shipmentFuture): " + shipmentFuture.get());
