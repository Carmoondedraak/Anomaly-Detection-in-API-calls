(function() {
    ...
    app.get("/card", function(req, res, next) {
        ...
        request(options, function(error, response, body) {
                 console.log("#########=START=#########");
                 console.log("GET:"+endpoints.customersUrl + '/' + custId + '/cards');
                 console.log("Options: " + JSON.stringify(options));
                 console.log("Response: " + JSON.stringify(response));
                 console.log("#########=END=#########");
            if (error) {
    ...
    app.get("/address", function(req, res, next) {
        ...
        request(options, function(error, response, body) {
                 console.log("########=START=##########");
                 console.log("GET:"+endpoints.customersUrl + '/' + custId + '/addresses');
                 console.log("Options: " + JSON.stringify(options));
                 console.log("Response: " + JSON.stringify(response));
                 console.log("#########=END=#########");
            if (error) {
    ...
    app.get("/login", function(req, res, next) {
        ...
        async.waterfall([
                ...
                function(custId, callback) {
                    ...
                    request(options, function(error, response, body) {
                     console.log("##########=START=########");
                     console.log("GET:"+endpoints.cartsUrl + "/" + custId + "/merge" + "?sessionId=" + sessionId);
                     console.log("Body: " + JSON.stringify(body));
                     console.log("Options: " + JSON.stringify(options));
                     console.log("Response: " + JSON.stringify(response));
                     console.log("#########=END=#########");
