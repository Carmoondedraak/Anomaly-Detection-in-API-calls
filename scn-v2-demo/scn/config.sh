...
SCN_HOST="https://gateways.demo.panoptica.app/"
...
export TYK_GATEWAY_DEPLOYMENT_NAMESPACE="tyk"
export TYK_PROXY_CONTAINER_NAME="tyk-gtw"
export TYK_GATEWAY_DEPLOYMENT_NAME="tyk-gtw"
